...
STRINGS = {
    ...
    'fa': {
        ...
        'safe_link': "✅ **گزارش SafeClick Guardian AI**\n\n"
                     "هوش مصنوعی SafeClick Guardian با تکیه بر پایگاه تهدید SentinelNet لینک زیر را بررسی کرد:\n"
                     "`{url}`\n\n"
                     "**نتیجه:** این لینک امن است و هیچ نشانه‌ای از کلاهبرداری یا بدافزار دیده نشد.\n"
                     "• تحلیل‌های چندلایه و سندباکس بدون هشدار بودند.\n"
                     "• SentinelNet این دامنه را کم‌ریسک گزارش می‌کند.\n\n"
                     ...
                     "📨 هر زمان خواستید، لینک دیگری بفرستید.\n\n"
